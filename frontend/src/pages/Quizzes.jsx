...
const Quizzes = () => {
  ...
  useEffect(() => {
    const fetchEvents = async () => {
      try {
        setLoading(true);
        const response = await eventService.getPublishedEvents("competition");
      ...
      <main className="flex-1 px-10 py-8">
        ...
        <section className="mb-12">
          ...
          <p className="text-slate-600 mb-8">
            Test your knowledge through exciting quizzes
          </p>

          {loading && <div className="text-center py-12">Loading quizzes...</div>}
