    ...
    <div className="flex w-full">
      ...
      <main className="flex-1 px-10 py-8">
        ...
        <section className="mb-12">
          <h2 className="text-3xl font-bold mb-2">College Festivals 🎉</h2>
          <p className="text-slate-600 mb-8">
            Join our exciting college festivals and celebrations
          </p>

          {loading && <div className="text-center py-12">Loading festivals...</div>}
